!(function (e, t) {
    ...
    He = (e, r) => {
      ...
      De.forEach((e) => {
        ...
        r.input &&
          ...
          (e = r),
          (t = Re(e.input)),
          "object" == typeof e.customClass && A(t, e.customClass.input));
    },
    qe = (t) => {
    ...
    Ne = (e, t, n) => {
      if (n.inputLabel) {
        ...
        i.setAttribute("for", e.id),
          (i.className = o),
          "object" == typeof n.customClass && A(i, n.customClass.inputLabel),
          (i.innerText = n.inputLabel),
          t.insertAdjacentElement("beforebegin", i);
      }
    },
    Re = (e) => P(g(), p[e] || p.input),
    Ue = (e, t) => {
      ...
      return e && t.icon === e.icon
        ...
        ? t.icon && -1 === Object.keys(o).indexOf(t.icon)
          ? (l(
            ...
            x(n))
          : (B(n), Xe(n, t), Ke(n, t), void A(n, t.showClass.icon))
        : x(n);
    },
    Ke = (e, t) => {
  ...
  function Rt(e, t, n, o) {
    re() ? zt(e, o) : (Ce(n).then(() => zt(e, o)), Dt(T)),
  ...
  class D {
    ...
    _main(e) {
      var t =
        ...
        e =
          (J(Object.assign({}, t, e)),
          T.currentInstance && (T.currentInstance._destroy(), ae() && at()),
      ...
      new Promise((e, t) => {
              ...
              (I(h()), Tt(a, t));
        {
          ...
          "function" == typeof r.willOpen && r.willOpen(c),
            ...
            ae() && (Bt(s, r.scrollbarPadding, e), it()),
            re() ||
