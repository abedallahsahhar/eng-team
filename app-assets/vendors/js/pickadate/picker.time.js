...
!function (a) {
    ...
    c.prototype.set = function (a, b, c) {
        ...
        return "flip" == c ? d.flipEnable() : !1 === c ? (d.flipEnable(1), e = []) : !0 === c ? (d.flipEnable(-1), e = []) : c.map(function (a) {
        ...
        return "flip" == c ? d.flipEnable() : !0 === c ? (d.flipEnable(1), e = []) : !1 === c ? (d.flipEnable(-1), e = []) : c.map(function (a) {
            var c, g, i, j;
            for (i = 0; i < f; i += 1) {
            ...
            if (c) for (i = 0; i < f; i += 1) if (d.isTimeExact(e[i], a)) {
                e[i] = null;
                break
            }
            if (j) for (i = 0; i < f; i += 1) if (d.isTimeOverlap(e[i], a)) {
                e[i] = null;
                break
            }
            c && e.push(c)
