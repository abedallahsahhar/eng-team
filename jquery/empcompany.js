     ...
     $.ajax({
          ...
          success: function (data) {
               $.each(data.P_RESULT_OUT, function (index, object) {
                    ...
                    let loadObject = {"file":object.PICTURE_BA64 };



                    $('#lightgallery').append(

                        '<li class="col-xs-6 col-sm-4 col-md-2"     data-src="data:image/jpeg;base64,' + object.PICTURE_BA64 + '" data-sub-html="<h4>Fading Light</h4><p>Classic '+'view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>" data-pinterest-text="Pin it1" data-tweet-text="share on twitter 1">'+
                        '<a href="" >'+
                        ' <img class="img-responsive" style="width: 170px; height: 130px;"  src="data:image/jpeg;base64,'  + object.PICTURE_BA64 + '" alt="Thumb-1">'+
                        '</a>'+

                        ' <a onclick="delete_file(' + object.ID + ')" class="btn btn-icon btn-circle btn-light-danger mr-2" style="    margin-left: 80px !important;            ">' +
                    ...
                    $.each(data.p_IMAGE, function (index, object) {
                         ...
                         if(data.p_IMAGE.PICTURE_BA64= "//8="){
                              ...
                              $('#lightgallery').append(
                                  ...
                                  '<h5><span class="badge badge-primary cursor-default" style="    margin-top: 19px;">'+object.DATE_D +'</span></h5>'+
                                  '</li>'+
                                  ' </ul>'+
