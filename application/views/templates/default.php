...
<body  style="  font-family: 'Cairo', sans-serif;" class="vertical-layout vertical-menu 2-columns  navbar-sticky" data-menu="vertical-menu" data-col="2-columns">
...
<?=$header?>
    ...
    <div class="wrapper" style="  font-family: 'Cairo', sans-serif;">
        ...
        <div  style="  font-family: 'Cairo', sans-serif;" class="app-sidebar menu-fixed" data-background-color="mint" data-image="<?php echo base_url().'app-assets/img/sidebar-bg/03.jpg'?>" data-scroll-to-active="true">
		<?=$quick_sidebar?>

        </div>

        <div  style="  font-family: 'Cairo', sans-serif;" class="main-panel">
            <!-- BEGIN : Main Content-->
			<?=$content?>
    ...
    <aside  style="  font-family: 'Cairo', sans-serif;" class="notification-sidebar d-none d-sm-none d-md-block" id="notification-sidebar"><a class="notification-sidebar-close"><i class="ft-x font-medium-3 grey darken-1"></i></a>
