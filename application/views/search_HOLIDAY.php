                    ...
                    <div class="card card-custom gutter-b ">
                        <div class="card-header bg-light-light">
                            <div class="card-title ">
                                <h3 class="card-label labal-color-light">بحث الاجازات </h3>
                            </div>
                        </div>
                        ...
                        <div class="card-body ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control   select2" ID="SECTION1"
                        ...
                        <div class="alert bg-light-success mb-2" role="alert">
                            ...
                            <div class="card-footer bg-light-light text-center">
                                <button type="submit" class="btn gradient-mint " id="btn_insert_data" onclick="search_HOLIDAY();">بحث <i class="ft-search"> </i></button>
...
<div class="card card-custom gutter-b">
    ...
    <div class="card-body">
        <!--begin: Datatable-->
        <table class="table table-striped table-bordered dom-jQuery-events dataTable" id="search_HOLIDAY">
