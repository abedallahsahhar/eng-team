...
<script src= '<?php echo base_url()."jquery/empoholedayboos.js"?>' type="text/javascript" ></script>
                        ...
                        <div class="card-body d-flex align-items-center justify-content-between flex-wrap py-3">
                            ...
                            <div class="d-flex align-items-center mr-2 py-2">
                                ...
                                <ul class="nav nav-pills ml-2 mt-3" id="pills-tab" role="tablist">
                                    <li class="nav-item" >
                                        <a class="nav-link active btn btn-outline-success mr-1 mb-1" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true"><i class="ft-layers" style="    padding: inherit;">اجازات الموظفين</i></a>
                                    </li>
<!--                                    <li class="nav-item" style="    margin-right: 35px;">-->
<!--                                        <a class="nav-link btn btn-outline-success mr-1 mb-1" id="pills-profile-tab " data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false"><i class="ft-link"> الاجازات 2</i></a>-->
<!--                                    </li>-->
                                    <li class="nav-item" style="    margin-right: 35px;">
                                        <a class="nav-link btn btn btn-outline-success mr-1 mb-1" id="pills-profile1-tab " data-toggle="pill" href="#pills-profile1" role="tab" aria-controls="pills-profile" aria-selected="false"><i class="ft-pocket">اجازات رؤساء  الاقسام</i></a>
                                    </li>
                                </ul>
                ...
                <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="card card-custom">
                            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                <div class="card-title">
                                    <h4 class="card-label" style="    margin-right: 18px;">اجازات الموظفين
                                    </h4>
                                </div>
                            ...
                            <!--begin: Datatable-->
                                ...
                                <div class="card-body">
                            <table class="table table-striped table-bordered dom-jQuery-events dataTable" id="get_holydayBOSS3">
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        ...
                        <div class="card card-custom">
                            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                ...
                                <div class="card-body">
                                <table ID="get_holydayBOSS1" class="table table-striped table-bordered dom-jQuery-events dataTable"  role="grid">
                                </table>
                            </div> </div>
                    ...
                    <div class="tab-pane fade" id="pills-profile1" role="tabpanel" aria-labelledby="pills-profile1-tab">
                        ...
                        <div class="card card-custom">
                            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                <div class="card-title">
                                    <h4 class="card-label" style="    margin-right: 18px;">اجازات رؤساء  الاقسام
                                    </h4>
                                </div>
                                <div class="card-toolbar">
                                    <!--begin::Dropdown-->
                            ...
                            <div class="card-body">
                                <table ID="get_holydayBOSS2" class="table table-striped table-bordered dom-jQuery-events dataTable"  role="grid">
                                </table>
                            </div> </div>
