    ...
    <!--end::Svg Icon-->
                        ...
                        <div class="d-flex align-items-center ">
                            ...
                            <div class="flex-grow-1 card-spacer-x pt-5">
                                <div class="text-inverse-info font-weight-bolder font-size-h3" style="color: black !important;">المهام الواردة  </div>
                                <div class="text-inverse-info font-weight-bold font-size-h6 " style="color: black !important; margin-right: 47px;"><span id="count1"></span></div>
                            </div>
                        </div>
...
<span class="svg-icon svg-icon-danger svg-icon-4x">
    ...
    <!--end::Svg Icon-->
                        ...
                        <div class="d-flex align-items-center ">
                            ...
                            <div class="flex-grow-1 card-spacer-x pt-5">
                                <div class="text-inverse-info font-weight-bolder font-size-h3" style="color: #f64e60  !important;     margin-right: 12px;
">المهام المنجزة </div>
                                <div class="text-inverse-info font-weight-bold font-size-h6 " id="count2" style="color: #f64e60 !important; margin-right: 47px;">23</div>
                            </div>
                        </div>
                ...
                <div class="card card-custom wave wave-animate-fast wave-danger">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center ">
                            ...
                            <div class="flex-grow-1 card-spacer-x pt-5">
                                <div class="text-inverse-info font-weight-bolder font-size-h3" style="color: #11c3f9  !important;     margin-right: 12px;">المهام المتاخرة </div>
                                <div class="text-inverse-info font-weight-bold font-size-h6 " id="count3" style="color: #11c3f9 !important; margin-right: 47px;">23</div>
                            </div>
                        </div>
    ...
    <!--end::Svg Icon-->
                        ...
                        <div class="d-flex align-items-center ">
                            ...
                            <div class="flex-grow-1 card-spacer-x pt-5">
                                ...
                                <div class="text-inverse-info font-weight-bold font-size-h6 " id="count4" style="color: #fddf0a !important; margin-right: 47px;">23</div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body">
                    <!--begin: Datatable-->
                    <table class="table table-striped table-bordered dom-jQuery-events dataTable" ID="get_task">
