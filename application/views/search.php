    ...
    <div class="card card-custom gutter-b ">
        <div class="card-header bg-light-light">
            <div class="card-title ">
                <h3 class="card-label labal-color-light"> بحث الموظفين </h3>
            </div>
        </div>
                ...
                <div class="col-md-10 col-xxl-7">
                        ...
                        <div class="input-group">
                            ...
                            <div class="col-md-3">
                                    <label for="" class="form__label control-label  "
                                           style="    left: 12rem !important;">رقم الهويه
                                    </label>

                                    <input
                                           type="text" class="form-control form__input center" placeholder=" "
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" data-date-format="yyyy-dd-mm"
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-control   select2" ID="SECION"
...
<!--                                   class=" form-control pickadate-selectors" ID="p_dateendcontract_to"-->
<!--                                   placeholder=" " />-->
<!---->
<!---->
<!---->
<!--                        </div>-->
                       ...
                       <div class="row" style="  margin-top: 20px;">
                           <div class="col-md-3">
                               <label for="" >   حالة الموظف
                               </label>
                               <select class="form-control   select2" ID="STATUSJOB"
                                       name="pa21r4am" data-placeholder="  حالة الموظف ">
                                   <option value="0">يعمل</option>
           ...
           <div class="card-footer bg-light-light text-center">
               <button type="submit" class="btn gradient-mint " id="btn_insert_data"   onclick="search_data();">بحث <i class="ft-search"> </i></button>

               <button class="btn gradient-pomegranate"  onclick="clear_input();">
...
<div class="card card-custom gutter-b">
    ...
    <div class="card-body">
        <!--begin: Datatable-->
        <table class="table table-striped table-bordered dom-jQuery-events dataTable" id="search_data">
