...
<link href="<?php echo base_url().'https://fonts.googleapis.com/css?family=Open+Sans' ?>" rel="stylesheet">
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4" style="    margin-right: 90px;">
            ...
            <a href="<?php echo base_url().'main_ctr/empoholedayboos' ?>" class="card human-resources">
        ...
        <div class="col-md-4" style="    margin-right: 66px;">

            <a href="<?php echo base_url().'main_ctr/empoutboos' ?>" class="card credentialing">
    <div class="overlay"></div>
    <div class="circle">
...
<!--        <div class="col-md-3">-->
<!---->
<!--                <a href="--><?php //echo base_url().'main_ctr/alltaskboss' ?><!--"  class="card wallet">-->
<!--    <div class="overlay"></div>-->
<!--    <div class="circle">-->
<!---->
<!---->
...
<!--        <div class="col-md-3">-->
<!---->
<!--            <a href="--><?php //echo base_url().'main_ctr/all_timeemp' ?><!--"  class="card education">-->
<!--                <div class="overlay"></div>-->
<!--                <div class="circle">-->
<!---->
