...
<div class="container" id="container">
  <div class="form-container sign-in-container">
      ...
      <h1 style="    margin-bottom: 83px;"> تسجيل الدخول</h1>

      <input  ID="P_CARDID"  placeholder="  رقم المستخدم" />
      <input ID="P_PASSWORD" type="password" placeholder="كلمة السر" />

          <div ><span style="color: red;font-size: 18px;     display: none;" id="login_msg"></span>
          </div>
<!--      <a href="#"> نسيت كلمة المرور؟ </a>-->
      <button onclick="login();" style="    margin-top: 43px;"> تسجيل الدخول</button>
      </form>
