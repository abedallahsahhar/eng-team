...
<!--    <div class="profile__cta"><a class="button">Adopt Doggo!</a></div>-->
    ...
    <section>
        <div class="profile profile-long">
            <div class="profile__image"><img  src="data:image/jpeg;base64,   <?php echo $this->session->userdata('PICTURE')  ?> " alt="Doggo"/></div>
            <div class="profile__info">
                <h4>مرحبا/          <?php $name = $this->session->userdata('FULLNAME'); echo $name; ?>
                </h4>
<!--                <p class="profile__info__extra">A very good boi that loves playing fetch and ice-cream! Gentle with everyone. Scared of the rain.</p>-->
            ...
            <div class="profile__stats" style="    margin-top: -54px;">


                <button class="btn-hover color-1 " onclick="insert_timeemp();"> تسجيل حضور <i class="ft-calendar">
                    </i></button>
            </div>
            <div class="profile__stats" style="    margin-top: -54px;">

                <button class="btn-hover color-2 " onclick="UPDATE_timeemp();"> تسجيل انصراف <i class="ft-external-link">
                    </i></button>
            </div>
    ...
    <input type="hidden" id="DATE_DAY" class="form-control " placeholder=" "  data-date-format="dd-mm-yyyy" readonly>
    <input type="hidden"  id="NAME" type="text" class="form__input center form-control"  value='<?php $name = $this->session->userdata('FULLNAME'); echo $name; ?>' readonly>
    <input type="hidden" id="TIME_COM" type="text" class="form__input center form-control" placeholder=" " readonly>
...
<!--                <div class="row">-->
<!--                    <div class="col-md-5">-->
<!--                            <label for="" class="form__label control-label " > تاريخ اليوم</label>-->
<!---->
...
<!--                    <div class="col-md-3" >-->
<!---->
<!--                    <button class="btn-hover color-1 " onclick="insert_timeemp();"> تسجيل الدخول <i class="fa fa-plus fa-1x">-->
<!--                        </i></button>-->
<!--                    </div>-->
<!---->
<!--                </div>-->
...
<!---->
<!---->
<!--                        <button class="btn-hover color-2 " onclick="UPDATE_timeemp();"> تسجيل انصراف <i class="fa fa-plus fa-1x">-->
<!--                            </i></button>-->
<!---->
<!---->
<!---->
...
<!--<!               <button class="btn gradient-mint " onclick="insert_timeemp();"> تسجيل الدخول <i class="fa fa-plus fa-1x">-->
<!--<!-                  </i></button>-->
<!--<!-              <button class="btn gradient-mint " onclick="UPDATE_timeemp();"> تسجيل انصراف <i class="fa fa-plus fa-1x">-->
<!--<!-                   </i></button>-->
<!--<!-           </div>-->
<!---->
<!--        </div>-->
...
<div class="card card-custom gutter-b">
    <div class="card-header flex-wrap border-0 pt-6 pb-0" data-background-color="man-of-steel">
        <div class="card-title">
            <h4 class="card-label" style="    margin-right: 18px;">  جدول الحضور
            </h4>
        </div>
    </div>
    <div class="card-body">
        <!--begin: Datatable-->
        <table style="    font-weight: bold;"  class="table table-striped table-bordered dom-jQuery-events dataTable" id="get_timeemp">
        </table>
        <!--end: Datatable-->
    </div>
</div>
